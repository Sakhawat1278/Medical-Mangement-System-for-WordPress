...
import WardCabinBookingStandalone from './WardCabinBookingStandalone.jsx'
import './index.css'
...
const rootElement = document.getElementById('ecare-ward-booking-root')
...
if (rootElement) {
  ...
  const primaryColor = window.ecareConfig?.settings?.primaryColor || '#0284c7'
  if (primaryColor) {
